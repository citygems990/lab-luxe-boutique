...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "О лабораторных бриллиантах — LUMEN" },
    ...
    <div className="container-luxe py-16 md:py-24">
      <Reveal className="max-w-3xl">
        ...
        <p className="mt-6 text-lg text-muted-foreground">
          Лабораторные бриллианты создаются из углерода в условиях, повторяющих природные — давление и температура земной мантии. Результат — камень, идентичный природному во всём, кроме происхождения.
        </p>
      </Reveal>
      ...
      <div className="mt-20 grid gap-px bg-border md:grid-cols-2">
        {[
          ...
          { Icon: ShieldCheck, title: "Прозрачная цепочка", text: "Каждый камень имеет паспорт лаборатории и независимый сертификат IGI или GIA." },
