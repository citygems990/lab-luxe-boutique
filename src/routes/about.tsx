    ...
    <div className="container-luxe py-16 md:py-24">
      ...
      <div className="mt-20 grid gap-px bg-border md:grid-cols-2">
        {[
          ...
          { Icon: Sparkles, title: "Идентичная структура", text: "Sp³-связи углерода, твёрдость 10 по Моосу, тот же показатель преломления и дисперсия — отличить только специальным оборудованием." },
