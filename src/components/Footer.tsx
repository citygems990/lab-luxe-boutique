      ...
      <div className="container-luxe grid gap-10 py-16 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-serif text-2xl">LUMEN<span className="text-gold">.</span></span>
          </div>
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-primary-foreground/70">hello@lumen-diamonds.com<br />+7 (495) 000-00-00</p>
        </div>
        <div>
          <h4 className="font-serif text-lg">Сертификация</h4>
          <p className="mt-3 text-sm text-primary-foreground/70">IGI · GIA<br />Каждый камень с паспортом</p>
        </div>
      </div>
      <div className="border-t border-white/10 py-6 text-center text-xs text-primary-foreground/50">
        © {new Date().getFullYear()} LUMEN Lab Diamonds. Все права защищены.
      </div>
    </footer>
  );
}
